                              ...
                              <div className="text-center grid grid-cols-2 grid-rows-2 gap-1">
                                ...
                                >
                                  <button
                                    ...
                                    onClick={async () => {
                                      try {
                                        const response = await axios.get(`https://mcfapis.bnbdevelopers.in/sendVisitingCard?sid=${item.sid}`);
                                        console.log(response.data);
                                        // Show a success message
                                        alert('Visiting card sent successfully!');
                                      } catch (error) {
                                        console.error(error);
                                        // Show an error message
                                        alert('Failed to send Visiting card. Please try again.');
                                      }
                                    }}
                                  >
                                    Send via Email
                                ...
                                onClick={async (e)=>{
                                  const res = await axios.get(`https://mcfapis.bnbdevelopers.in/sendVisitingCard_wp?sid=${item.sid}`);
                                  toast('Visiting Card sent...');
                                }}
                                >
                                  Send via Whatsapp
