...
import data from '../data/CancelledStu.json';
            ...
            <div className="grid grid-cols-12 gap-6">
              <div className="col-span-full xl:col-span-12 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
                <header className="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
                  <h2 className="font-semibold text-slate-800 dark:text-slate-100">Cancelled Students List</h2>
                </header>
                <div className="p-4">
                  {/* Table */}
                          ...
                          <tr key={index}>
                            ...
                            <td className="p-4">
                              <div className="text-center grid grid-cols-2 grid-rows-2 gap-2 h-full">
                                ...
                                <button className="text-sm text-white px-2 bg-green-500 rounded-full"
                                  style={{ padding: '1px', fontSize: '13px' }}>
                                    Active
                                </button>
                              </div>
