...
import data from '../data/ReportCard.json';
            ...
            <div className="grid grid-cols-12 gap-6">
              <div className="col-span-full xl:col-span-12 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
                <header className="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
                  <h2 className="font-semibold text-slate-800 dark:text-slate-100">Report Cards</h2>
                </header>
                <div className="p-4">
                  {/* Table */}
                          ...
                          <tr key={index}>
                            ...
                            <td className="p-2">
                              <div className="flex items-center">
                                <div className="text-slate-800 dark:text-slate-100">{item.RegId}</div>
                              </div>
                            </td>
                            <td className="p-2">
                              <div className="flex items-center">
                            ...
                            <td className="p-2">
                              <div className="text-center">{item.venue}</div>
                            </td>
                            <td className="p-2">
