                    ...
                    >
                      <thead className="text-xs uppercase text-slate-400 dark:text-slate-500 bg-slate-50 dark:bg-slate-700 dark:bg-opacity-50 rounded-sm">
                        <tr>
                          ...
                          <th className="p-2">
                            <div className="font-semibold text-center"> Entrance Card</div>
                          </th>
                        </tr>
                      </thead>
                              ...
                              <div className="text-center grid grid-cols-3 grid-rows-1 gap-1">
                                ...
                                >
                                  <button
                                    ...
                                    onClick={async () => {
                                      try {
                                        const response = await axios.get(`https://mcfapis.bnbdevelopers.in/sendEntranceCard?sid=${item.sid}`);
                                ...
                                <button className={`text-sm text-white py-1 px-1  ${smsLoading?'bg-green-300':'bg-green-500'}`}
                                disabled={smsLoading}
                                onClick={async (e)=>{
                                  setSmsLoading(true);
                                  const res = await axios.get(`https://mcfapis.bnbdevelopers.in/sendEntranceCard_sms?sid=${item.sid}`);
                                ...
                                onClick={async (e)=>{
                                  const res = await axios.get(`https://mcfapis.bnbdevelopers.in/sendEntranceCard_wp?sid=${item.sid}`);
                                  toast('Entrance Card sent...')
                                }}
                                >
                                  Send via Whatsapp
