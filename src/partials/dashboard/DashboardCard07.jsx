              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800 dark:text-slate-100">Camp 1</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">City 1</div>
                </td>
                <td className="p-2">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800 dark:text-slate-100">Camp 2</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">City 2</div>
                </td>
                <td className="p-2">
                  <div className="text-center text-emerald-500">Active</div>
                </td>
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800 dark:text-slate-100">Camp 3</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">City 3</div>
                </td>
                <td className="p-2">
                  <div className="text-center text-red-500">Inactive</div>
                </td>
                <td className="p-2">
                  <div className="text-center">22,499</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800 dark:text-slate-100">Camp 4</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">City 4</div>
                </td>
                <td className="p-2">
                  <div className="text-center text-red-500">Inactive</div>
                </td>
                <td className="p-2">
                  <div className="text-center">12,999</div>
                </td>               
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800 dark:text-slate-100">Camp 5</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">City 5</div>
                </td>
                <td className="p-2">
                  <div className="text-center text-emerald-500">Status</div>
                </td>
                <td className="p-2">
                  <div className="text-center">20,499</div>
                </td>
