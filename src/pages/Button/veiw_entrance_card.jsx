            ...
            <div className="BoxA border-1 p-4 mb-4">
              ...
              <div className="w-1/4 flex items-center mr-16">
                ...
                <div className="w-3/4 flex justify-around ml-14">
                  <h5 className="text-4xl font-bold p-2 border">MARSHAL CADET FORCE</h5>
                  <p className="font-xl">
  ...
  <tbody>
    <tr>
      <td className="font-bold border p-2">
        Student Name : <span className="font-normal">Vinod Sharma</span>{" "}
      </td>
    </tr>
    <tr>
      <td className="font-bold border p-2">
    ...
    <tr>
      <td className="font-bold border p-2">
        Father Name : <span className="font-normal">S S Sharma</span>
      </td>
    </tr>
    <tr>
      <td className="font-bold border p-2">
        ENROLLMENT NO : <span className="font-normal">99887766</span>{" "}
      </td>
    </tr>
    <tr>
      <td colSpan="2" className="font-bold border p-2">
        Address : <span className="font-normal">Viman Nagar</span>
      </td>
    </tr>
    <tr>
      <td className="border p-2">
        <b>Course: </b> B.TECH
            ...
            <footer className="text-center mt-2">
              <p className="text-gray-600">***************************** MARSHAL CADET FORCE *****************************</p>
            </footer>
          </div>
        </div>
      </section>
